...
Conclusion:
We observed that our originial two cases are now limited only to simple convex function.It can be seen from the plots that the algoithms are performing pretty well for non-convex case.
Reference:
